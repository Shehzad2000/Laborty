...
namespace LaboratoryMS_Shehzad.API
{
    public class Startup
    {
        ...
        private void ConfigureProviders(IServiceCollection services)
        {
            ...
            services.AddScoped<ITestPriceProvider, TestPriceProvider>();
            services.AddScoped<ITestProvider, TestProvider>();
            services.AddScoped<IUnitProvider, UnitProvider>();
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<LogConfig>(x => Configuration.GetSection("LogConfig").Bind(x));
